...
function main() {
  ...
  if (eventName === "SessionStart") emitOutput({ hook: "hermes.SessionStart", workspaceRoot: resolveWorkspaceRoot(cwd), timestamp: nowIso() });
  else if (eventName === "SessionEnd") emitOutput({ hook: "hermes.SessionEnd", workspaceRoot: resolveWorkspaceRoot(cwd), timestamp: nowIso() });
}
main();